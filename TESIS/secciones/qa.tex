...
\begin{figure}[h!]
  \centering
  \fbox{\includegraphics[width=0.9\textwidth]{imagenes/metodoprueba}}
...
\begin{figure}[!h]
 \centering
 \fbox{\includegraphics[width=0.6\textwidth]{imagenes/pruebasCods}}
...
\begin{figure}
 \centering
 \fbox{\includegraphics[width=0.6\textwidth]{imagenes/pruebasEncuentro}}
