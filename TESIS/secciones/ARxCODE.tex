...
\begin{figure}[h!]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{imagenes/pantalla0}}
...
\begin{figure}[!h]
\centering
  \subfigure[Impresi\'on de la pantalla de Procesamiento de CDM del ARxCODE]{
    \fbox{\includegraphics[width=0.45\textwidth]{imagenes/pantalla1}}
  }
  \hspace{0.5cm}
  \subfigure[Impresi\'on de la pantalla del ingreso manual de datos del ARxCODE]{
   \fbox{ \includegraphics[width=0.45\columnwidth, keepaspectratio]{imagenes/pantalla2}}
  }
  \caption{Pantallas de Ingreso de Datos, ya sea selecci\'on del CDM o carga manual}
