...
\item Propagar la posici\'on del desecho espacial involucrado, con un m\'etodo de propagaci\'on de errores.
\item Utilizar los productos orbitales de la misi\'on o realizar el mismo procedimiento que se aplica al desecho, a la misi\'on.
\item Cacular la m\'inima distancia, total o en la coordenada radial.
