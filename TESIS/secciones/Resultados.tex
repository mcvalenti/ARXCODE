...
Finalmente la implementaci\'on del c\'alculo de probabilidad de colisi\'on fue evaluado a partir de la recopilaci\'on de bibliograf\'ia con datos de encuentros anteriores, adquiridos a trav\'es de correos electr\'onicos o CDM p\'ublicos.\\
...
\begin{tabular}{|l|r|r|r|r|r|r|}
 ...
 \hline
\end{tabular} }
\caption{Resultados que se obtienen con ARxCODE a partir de la informaci\'on de los correos electr\'onicos, propagando cada 1 segundo - (Radio de colisi\'on $r_{a}=0.01$ km)}
\label{tab:mails1seg}
\end{table}
...
\begin{tabular}{|l|r|r|r|r|r|r|}
 ...
 \hline
\end{tabular} }
\caption{Resultados que se obtienen con ARxCODE incorporando a la informaci\'on de los correos electr\'onicos, el valor de los segundos en el TCA y propagando cada 100.000 microsegundos - (Radio de colisi\'on $r_{a}=0.01$ km)}
...
\begin{tabular}{|l|c|c|c|c|c|c|c|}
 ...
 \hline
\end{tabular} }
\caption{Comparaci\'on de las m\'inimas distancias de acercamiento y las PoC calculadas con ARxCODE con los resultados publicados por Klinkrad \citep{Klinkard}. Paso de propagaci\'on cien mil $\mu$s y radio de colisi\'on $r_{a}=0.01$ km}
\label{tab:escenariosKlinkrad}
\end{table}

Por otro lado, en el trabajo de Xu y  Xiong, \citep{xu2014method} se publican las estimaciones de la m\'inima distancia y la Poc tanto utilizando un m\'etodo general y el m\'etodo desarrollados por ellos (tabla de ). Se utiliz\'o la informaci\'on de los encuentros que se listan en ese trabajo para intentar reproducir los resultados con ARxCODE. \\
...
\begin{figure}[!h]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{imagenes/klinkradEsc4}}
...
\begin{figure}[!h]
  \centering
  \fbox{\includegraphics[width=0.7\textwidth]{imagenes/klinkradEsc5}}
  \caption{An\'alisis de la Probabilidad de Colisi\'on en funci\'on del radio de colisi\'on}
