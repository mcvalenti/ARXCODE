...
En la mayor\'ia de los casos, las \'orbitas son circulares o casi circulares. En esta configuraci\'on el m\'aximo acercamiento de los objetos ocurre siempre en posiciones cercanas a los puntos de m\'aximo acercamiento de las \'orbitas; y para las \'orbitas circulares esto se da exactamente en la l\'inea de intersecci\'on de los planos orbitales de los dos objetos, (Fig. \ref{fig:pocorbcirc}).\\

\begin{figure}[!h]
\begin{minipage}[t]{0.48\textwidth}
 \centering
 \fbox{\includegraphics[width=0.8\textwidth]{imagenes/poccirc1}}
 \caption[M\'aximo acercamiento en \'orbitas circulares]{El punto de m\'aximo acercamiento en \'orbitas casi circulares ocurre siempre en puntos cercanos a los puntos m\'as pr\'oximos de las \'orbitas. Extra\'ido de Lei-Chen. \citep{leichen}.}
