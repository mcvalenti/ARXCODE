...
\subsection{Expresi\'on Anal\'itica Simplifiacada \ref{leichen}}



Dados dos objetos, ambos en \'orbitas circulares ... bajo \textcolor{red}{Teor\'ia de Leiche},
\subsubsection*{Proyecci\'on al plano de encuentro} \label{subsec:planoencuentro}
...
analizando el problema en el plano de encuentro (\textcolor{red}{definirlo}), la probabilidad de colisi\'on se calcula mediante la integral:
...
puede encontrarse una expresi\'on anal\'itica simplificada para el c\'alculo de la probabilidad de colisi\'on.\\
