...
\subsection{El c\'alculo de la PoC}
...
En este trabajo se implementaron tres m\'etodos de distinta complejidad. En primer lugar se utiliza una expresi\'on muy simplificada que no contempla los errores de las posiciones. Luego se utiliza una aproximaci\'on del m\'etodo de Chan \citep{chan2003improved} propuesta por Lei-Chen \citep{leichen} y finalmente se calcula la integral de la PoC en dos dimensiones utilizando el m\'etodo de Akella \citep{akellaAlfriend}.

\susubbsection{M\'etodo del l\'imite}
...
%\subsubsection{M\'etodo de Akella}
