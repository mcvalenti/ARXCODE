...
\begin{figure}[htbp]
 \centering
  \subfigure[Procesamiento de Datos de Mision]{\includegraphics[width=0.46\linewidth]{imagenes/CODS_setPri_37673U}}
  \subfigure[Procesamiento de TLEs]{\includegraphics[width=0.46\linewidth]{imagenes/TLE_setPri_37673}}
