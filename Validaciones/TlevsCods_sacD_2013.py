...
def divide_setTLE(noradId,archivo):
    ...
    """
    ruta_tle = r'../TleAdmin/tle_sacD_2013/' 
    if not os.path.exists(ruta_tle): os.makedirs(ruta_tle)
    
    files=glob.glob('../TleAdmin/tle_sacD_2013/*')
    ...
    for i in range(0,largo-1,2):
        salida=open('../TleAdmin/tle_sacD_2013/'+noradId+'tle'+str(m),'w+')
        linea1=filas[i]
        linea2=filas[i+1]
...
if __name__=='__main__':
    ...
    """
    tle_files=glob.glob('../TleAdmin/tle_sacD_2013/*')
    cods_files=glob.glob('../CodsAdmin/CUSS_CODS/DENSEPHEM_2013/*.TXT')
...
#             print '======================================================================================'
    ...
    fig.suptitle('Diferencias posicion del TLE y coordenadas precisas (SAC-D 2013)')
